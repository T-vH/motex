...
# CONFIG
# =========================
file_path = Path(r"C:\Users\thoma\Downloads\FMP Survey User Test.xlsx")
...
# =========================
# PLOT COLLAGE (FINAL POLISH)
# =========================
fig, axes = plt.subplots(2, 2, figsize=(12, 5))  # ⬅️ less height (was 10)
axes = axes.flatten()

# Flatten titles (no line breaks)
flat_titles = {
